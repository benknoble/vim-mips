...
" based on modifications from
" https://github.com/harenome/vim-mipssyntax/blob/master/syntax/mips.vim
...
syntax match mipsStorage /\.2byte/
syntax match mipsStorage /\.4byte/
syntax match mipsStorage /\.8byte/
syntax match mipsStorage /\.ascii/
syntax match mipsStorage /\.asciiz/
syntax match mipsStorage /\.byte/
syntax match mipsStorage /\.double/
syntax match mipsStorage /\.dword/
syntax match mipsStorage /\.float/
syntax match mipsStorage /\.gpword/
syntax match mipsStorage /\.half/
syntax match mipsStorage /\.space/
syntax match mipsStorage /\.struct/
syntax match mipsStorage /\.word/
"}}}
...
"" Highlights Linking {{{
highlight def link mipsChar Character
highlight def link mipsComment Comment
highlight def link mipsString String
highlight def link mipsNumber Number
highlight def link mipsRegister Identifier

highlight def link mipsStorage Type

highlight def link mipsOperator Operator

highlight def link mipsAlias mipsInstruction
highlight def link mipsPseudoInstruction mipsInstruction
highlight def link mipsMacro mipsInstruction
highlight def link mipsInstruction Statement

highlight def link mipsMacroDefine Macro
highlight def link mipsMacroParameter Identifier
highlight def link mipsInclude Include
highlight def link mipsDefine Define
highlight def link mipsDirective PreProc
highlight def link mipsLabel Label
""}}}
